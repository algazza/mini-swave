...
<div class="grid grid-cols-2 gap-2 sm:gap-4 w-full overflow-hidden">
  {#each products as product (product.id)}
    ...
    >
      ...
      <!-- Details - Minimalist mobile view -->
      <div class="p-2 sm:p-3">
        ...
        <div class="hidden sm:block">
          <h3 class="text-xs font-semibold text-black truncate leading-tight">{product.name}</h3>
